...
var Toolbar = /** @class */ (function (_super) {
    ...
    Toolbar.prototype.render = function () {
        ...
        }), DropdownToolbarButton, createToolbarItemInfo('more'), dropdownItems, this.props.document, props, Popup, popupInfo, showPopup, eventEmitter, this.hidePopup, this.execCommand, this.props.document);
    };
    return Toolbar;
}(Component));
...
var Layout = /** @class */ (function (_super) {
    ...
    Layout.prototype.render = function () {
        var _this = this;
        var _a = this.props, eventEmitter = _a.eventEmitter, hideModeSwitch = _a.hideModeSwitch, toolbarItems = _a.toolbarItems, theme = _a.theme, document = _a.document;
...
var ToastUIEditor = /** @class */ (function (_super) {
    ...
    function ToastUIEditor(options) {
        ...
        var layoutComp;
        var destroy = render(_this.options.el, html(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n        <", "\n          ref=", "\n          eventEmitter=", "\n          slots=", "\n          hideModeSwitch=", "\n          toolbarItems=", "\n          previewStyle=", "\n          editorType=", "\n          theme=", "\n          document=", "\n        />\n      "], ["\n        <", "\n          ref=", "\n          eventEmitter=", "\n          slots=", "\n          hideModeSwitch=", "\n          toolbarItems=", "\n          previewStyle=", "\n          editorType=", "\n          theme=", "\n          document=", "\n        />\n      "])), Layout, function (layout) { return (layoutComp = layout); }, _this.eventEmitter, _this.getEditorElements(), _this.options.hideModeSwitch, _this.options.toolbarItems, _this.options.previewStyle, _this.options.initialEditType, _this.options.theme, _this.options.document));
